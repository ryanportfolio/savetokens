...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-09-03, global scope)
>
> | | |
> |---|---|
> | **[M] 63.6%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 159,439 commands, 192.7M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~135M tokens, no before-and-after log |
<!-- END:readme-figures -->
