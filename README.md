...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-21, global scope)
>
> | | |
> |---|---|
> | **[M] 40.1%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 133,055 commands, 39.2M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~123M tokens, no before-and-after log |
<!-- END:readme-figures -->
