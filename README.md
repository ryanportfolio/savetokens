...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-09, global scope)
>
> | | |
> |---|---|
> | **[M] 48.0%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 118,390 commands, 26.4M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~101M tokens, no before-and-after log |
<!-- END:readme-figures -->
