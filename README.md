...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-07-20, global scope)
>
> | | |
> |---|---|
> | **[M] 79.5%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 95,821 commands, 19.7M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~69M tokens, no before-and-after log |
<!-- END:readme-figures -->
