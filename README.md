...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-07-31, global scope)
>
> | | |
> |---|---|
> | **[M] 49.9%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 109,168 commands, 23.6M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~88M tokens, no before-and-after log |
<!-- END:readme-figures -->
