...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-06, global scope)
>
> | | |
> |---|---|
> | **[M] 48.5%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 115,772 commands, 25.5M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~98M tokens, no before-and-after log |
<!-- END:readme-figures -->
