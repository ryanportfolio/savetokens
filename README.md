...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-07, global scope)
>
> | | |
> |---|---|
> | **[M] 48.2%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 116,862 commands, 25.8M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~99M tokens, no before-and-after log |
<!-- END:readme-figures -->
