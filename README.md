...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-17, global scope)
>
> | | |
> |---|---|
> | **[M] 48.0%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 126,054 commands, 32.7M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~114M tokens, no before-and-after log |
<!-- END:readme-figures -->
