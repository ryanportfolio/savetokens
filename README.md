...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-07-28, global scope)
>
> | | |
> |---|---|
> | **[M] 51.7%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 107,415 commands, 22.8M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~84M tokens, no before-and-after log |
<!-- END:readme-figures -->
