...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-03, global scope)
>
> | | |
> |---|---|
> | **[M] 49.6%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 111,834 commands, 24.5M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~92M tokens, no before-and-after log |
<!-- END:readme-figures -->
