...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-19, global scope)
>
> | | |
> |---|---|
> | **[M] 46.9%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 128,844 commands, 33.7M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~118M tokens, no before-and-after log |
<!-- END:readme-figures -->
