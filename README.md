...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-20, global scope)
>
> | | |
> |---|---|
> | **[M] 46.4%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 130,517 commands, 34.4M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~120M tokens, no before-and-after log |
<!-- END:readme-figures -->
