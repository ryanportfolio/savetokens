...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-09-25, global scope)
>
> | | |
> |---|---|
> | **[M] 55.2%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 217,024 commands, 254.8M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~148M tokens, no before-and-after log |
<!-- END:readme-figures -->
