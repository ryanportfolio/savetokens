...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-18, global scope)
>
> | | |
> |---|---|
> | **[M] 47.8%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 126,757 commands, 32.9M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~116M tokens, no before-and-after log |
<!-- END:readme-figures -->
