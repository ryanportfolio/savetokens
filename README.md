...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-16, global scope)
>
> | | |
> |---|---|
> | **[M] 48.1%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 124,982 commands, 32.4M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~112M tokens, no before-and-after log |
<!-- END:readme-figures -->
