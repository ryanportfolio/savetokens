...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-10, global scope)
>
> | | |
> |---|---|
> | **[M] 47.9%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 120,596 commands, 27.8M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~104M tokens, no before-and-after log |
<!-- END:readme-figures -->
