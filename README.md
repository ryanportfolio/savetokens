...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-28, global scope)
>
> | | |
> |---|---|
> | **[M] 54.4%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 147,297 commands, 92.9M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~131M tokens, no before-and-after log |
<!-- END:readme-figures -->
