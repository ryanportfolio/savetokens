...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-08, global scope)
>
> | | |
> |---|---|
> | **[M] 47.8%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 117,537 commands, 26.0M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~100M tokens, no before-and-after log |
<!-- END:readme-figures -->
