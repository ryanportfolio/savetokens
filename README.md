...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-07-19, global scope)
>
> | | |
> |---|---|
> | **[M] 81.8%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 93,690 commands, 19.1M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~65M tokens, no before-and-after log |
<!-- END:readme-figures -->
