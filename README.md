...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-26, global scope)
>
> | | |
> |---|---|
> | **[M] 52.3%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 144,938 commands, 82.1M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~130M tokens, no before-and-after log |
<!-- END:readme-figures -->
