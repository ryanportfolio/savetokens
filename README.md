...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-07-24, global scope)
>
> | | |
> |---|---|
> | **[M] 76.5%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 99,814 commands, 20.4M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~77M tokens, no before-and-after log |
<!-- END:readme-figures -->
