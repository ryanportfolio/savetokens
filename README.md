...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-07-29, global scope)
>
> | | |
> |---|---|
> | **[M] 49.6%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 107,938 commands, 22.9M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~85M tokens, no before-and-after log |
<!-- END:readme-figures -->
