...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-08-22, global scope)
>
> | | |
> |---|---|
> | **[M] 42.8%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 136,163 commands, 48.2M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~125M tokens, no before-and-after log |
<!-- END:readme-figures -->
