...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-09-24, global scope)
>
> | | |
> |---|---|
> | **[M] 55.8%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 206,519 commands, 251.3M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~147M tokens, no before-and-after log |
<!-- END:readme-figures -->
