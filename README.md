...
<!-- LIVE:readme-figures -->
> **Current characterization** (snapshot 2026-09-20, global scope)
>
> | | |
> |---|---|
> | **[M] 58.0%** | of output tokens removed by filtering command output before the agent reads it. rtk gain, 180,391 commands, 219.9M tokens saved |
> | **[E] ~50%** | shorter replies with caveman mode. Deliberately lowballed target, est ~142M tokens, no before-and-after log |
<!-- END:readme-figures -->
